...
public class HomeUiState {
    ...
    private HomeUiState(boolean isLoading,
    ...
    public static HomeUiState loading() {
        return new HomeUiState(true, "", "", Collections.emptyList(), Collections.emptyList(), "", 0, Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), null);
    }

    public static HomeUiState from(HomeContent content) {
    ...
    public List<HomeContent.Hero> getHeroes() {
        return heroes;
    }

    public List<HomeContent.QuickAction> getQuickActions() {
        return quickActions;
    }

    public String getContinueSubtitle() {
        return continueSubtitle;
    }
    ...
    public List<HomeContent.ComicCard> getRecentlyRead() {
        return recentlyRead;
    }

    public List<HomeContent.ComicCard> getRecommendations() {
        return recommendations;
    }

    public List<HomeContent.ComicCard> getNewUpdates() {
        return newUpdates;
    }

    public List<HomeContent.ComicCard> getHotComics() {
        return hotComics;
    }

    public List<HomeContent.ComicCard> getCompleted() {
        return completed;
    }

    public List<HomeContent.ComicCard> getNewComics() {
        return newComics;
    }
